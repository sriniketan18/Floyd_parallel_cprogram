...
void Floyd(int local_mat[], int n, int my_rank, int p, MPI_Comm comm); int Owner(int k, int p, int n); 
...
void Print_row(int local_mat[], int n, int my_rank, int i){ char char_int[100]; 
